...
| **明水與暗水屬性明確標示 (Explicit Ming-Shui & An-Shui Attributes Marking)** | 畫面上/下角落 viewport HUD | 全面升級水法指南文字標記：<br/>1. **🌊 左下角【屋外水法】**：明確標註「專指屋外露天【明水】溝渠與明路氣」；地下密閉水管（暗水）穿過無妨。<br/>2. **🏠 右下角【室內水法】**：明確標註「淨水進水/魚缸水景：【明水】必須置吉位 (牆內暗管無妨)」、「黑水排污/化糞池：隨暗水排煞 (露天明溝忌落吉位)」。權責劃分一目了然！ | ✅ 100% 正確 |
...
| **羅盤字級全盤加倍** | 九星、八卦、24 山標籤 | 九星文字倍增至 `22*fs` (外框 `135*38px`)；八卦文字倍增至 `32*fs`；二十四山文字倍增至 `28*fs`，遠觀極其清晰大氣 | ✅ 100% 正確 |
